...
class DailymotionMusicSearch extends AbstractMusicSearch{
    ...
    protected function executePopularQuery(){
        ...
        $this->videoQuery = array('fields'=>array('id','title','thumbnail_120_url','duration'),'filters'=>array('hd'), 'channel'=>'music','sort'=>'visited-week','limit'=>30);
        try{
             $feeds= $this->dailymotionService->get('/videos',$this->videoQuery);
    ...
    protected function buildQuery(){
        ...
        $this->videoQuery = array('fields'=>array('id','title','thumbnail_120_url','duration'),'channel'=>'music','sort'=>'relevance','search'=>$this->searchQuery->getSongQuery(),'limit'=>30);
